...
namespace Entity
{
    public class LiquidacionCuotaModeradora
    {
        ...
        {
            return $"{NumeroLiquidacion};{Identificacion};{Nombre};{TipoAfiliacion};{SalarioDevengado};{ValorServicioHospitalizacion};{CuotaModeradoraFinal};{CuotaModeradoraReal};{Tarifa};{Tope}";
        }
    }
}
